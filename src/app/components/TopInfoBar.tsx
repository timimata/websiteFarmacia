      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2 sm:py-3">
        <div className="flex flex-col sm:flex-row items-center justify-center md:justify-between gap-2 sm:gap-4 md:gap-6 text-xs sm:text-sm">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <a href={pharmacyContact.phoneHref} className="font-medium whitespace-nowrap hover:text-emerald-100 transition-colors min-h-[44px] sm:min-h-0 flex items-center">
              {pharmacyContact.phone}
            </a>
            <span className="opacity-60">|</span>
            <a href={pharmacyContact.phoneHref2} className="font-medium whitespace-nowrap hover:text-emerald-100 transition-colors min-h-[44px] sm:min-h-0 flex items-center">
              {pharmacyContact.phone2}
            </a>
          </div>
